...
func TestCoinMarketCapProvider_Name(t *testing.T) {
...
func TestCoinMarketCapProvider_FetchPrices(t *testing.T) {
	provider := NewCoinMarketCapProvider()
...
func TestCoinMarketCapProvider_FetchPrices_ContextCancellation(t *testing.T) {
	provider := NewCoinMarketCapProvider()
